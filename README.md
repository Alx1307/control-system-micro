...
# Описание проекта
Микросервисная система для управления заказами, предназначенная для инженеров, менеджеров и руководителей. Система обеспечивает регистрацию заказов, назначение инженеров на заказ, управление заказами.
